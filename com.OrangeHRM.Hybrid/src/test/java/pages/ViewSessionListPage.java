...
public class ViewSessionListPage {

	/** The driver. */
	WebDriver driver;
	
	/**
	 * Instantiates a new view session list page.
	 *
	 * @param lDriver the l driver
	 */
	public ViewSessionListPage(WebDriver lDriver) {
		// TODO Auto-generated constructor stub
		this.driver=lDriver;
		
	}
	
   @FindBy(id="menu_training_defaultTrainingModulePage") WebElement trainingTab;
